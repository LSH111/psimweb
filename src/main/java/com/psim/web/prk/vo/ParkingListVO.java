...
public class ParkingListVO {
    ...
    // 🔥 요금 정보
    private Integer dayFeeFirst30m;
    private Integer dayFeePer10m;
    private Integer dayFeePer60m;
    private Integer dayFeeDay;
    private Integer dayFeeMonthly;
    private Integer dayFeeHalfyear;
    private String dayFeeApplyCd;
    private String dayFeeApplyNm;

    private Integer nightFeeFirst30m;
    private Integer nightFeePer10m;
    private Integer nightFeePer60m;
    private Integer nightFeeDay;
    private Integer nightFeeMonthly;
    private Integer nightFeeHalfyear;
    private String nightFeeApplyCd;
    private String nightFeeApplyNm;
