...
<div class="wrap">
    <header class="card head">
        <div class="title" id="v_name"><c:out
                value="${empty parking.prkplceNm ? '노외주차장 상세' : parking.prkplceNm}"/></div>
        ...
        <span class="actions" style="margin-left:auto">
            ...
            <button class="btn" id="btnSaveTop"
                    <c:if test="${isApproved or isPending}">disabled="disabled"</c:if>>저장</button>
        </span>
    </header>
        ...
        <div class="grid">
            ...
            <div style="grid-column:1/-1">
                ...
                <div id="parking_guide_photo_wrap" class="photo-upload-zone" style="margin-top:8px; display:none;">
                    <input id="f_parking_guide_photo_lib" type="file" accept="image/*,image/heic,image/heif"
                           style="display:none"/>
                    <input id="f_parking_guide_photo_cam" type="file" accept="image/*" capture="environment"
                           style="display:none"/>
                    <div class="file-upload-buttons">
    ...
    <section class="card section-card">
        ...
        <div class="grid">
            <div style="grid-column:1/-1">
                ...
                <div class="ctl">
                    <textarea id="f_partclr_matter" name="rmk" rows="8" placeholder="주차장 관련 특이사항을 입력하세요"><c:out
                            value="${parking.partclrMatter}"/></textarea>
                </div>
            </div>
        </div>
    </section>
