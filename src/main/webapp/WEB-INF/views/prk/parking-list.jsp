            ...
            <div class="wrap">
                ...
                <section class="panel" aria-label="검색 조건">
                    ...
                    <div id="mapBackButton"
                         style="display:none; padding:12px 16px; background:#eff6ff; border-left:4px solid #3b82f6; margin-bottom:16px; border-radius:8px;">
                        <button onclick="goBackToMap()"
                                style="display:flex; align-items:center; gap:8px; background:white; border:1px solid #3b82f6; color:#2563eb; padding:10px 20px; border-radius:6px; cursor:pointer; font-size:14px; font-weight:600; transition: all 0.2s;">
                    ...
                    <form id="searchForm" class="krds-form">
                        <div class="filters krds-grid">
                            ...
                            <div>
                                ...
                                <div class="control">
                                    <input id="prkNm" name="prkNm" type="text" class="form-input"
                                           placeholder="예) 중앙공영주차장"/>
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="span2">
                                ...
                                <div class="control">
                                    <input id="addr" name="addr" type="text" class="form-input"
                                           placeholder="도로명/지번 등 일부를 입력"/>
                                </div>
                            </div>
                        </div>
